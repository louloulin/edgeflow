...
EdgeFlow can be used in conjunction with Docker to automatically discover **services** and route traffic to them.&#x20;
  ...
  my_service:
    ...
    deploy:
      labels:
        ...
        # By default, EdgeFlow won't discover any services where the value is not explicitly `true`
        edgeflow.enable: "true"

        # The hostname that the service should be available at. E.g. `example.com`.
        edgeflow.host: "example.com"
        ...
        edgeflow.headers.remove: "Server,X-User-Id"
```
