...
Early tests are promising, but there are many variants on how EdgeFlow performs under _real_ load.&#x20;
...
Using the following configuration we can see that EdgeFlow holds its own in regards to performance.
